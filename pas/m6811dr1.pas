...
Copyright(c)1996,1997 by Donald Whisnant
...
begin
     ...
     For I:=1 to NumOpcodes do
         begin
            If ObjectCodeNdx[ObjectCode[I].OpCode[1]].Legal=False then
            begin
              ObjectCodeNdx[ObjectCode[I].OpCode[1]].Legal:=True;
              ObjectCodeNdx[ObjectCode[I].OpCode[1]].Start:=I;
            end;
         end;
